# Generated by Django 4.0.5 on 2022-08-27 15:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('registernewproject', '0045_delete_tr401_alter_solarrooftop_endfile_date_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inputFile_date', models.DateTimeField(default=datetime.datetime(2022, 8, 27, 15, 0, 13, 649193), max_length=100)),
                ('endFile_date', models.DateTimeField(default=datetime.datetime(2023, 8, 20, 15, 0, 13, 649193), max_length=100)),
        ...
        migrations.AlterField(
            ...
            name='endFile_date',
            field=models.DateTimeField(default=datetime.datetime(2023, 8, 20, 15, 0, 13, 649193), max_length=100),
        ),
        migrations.AlterField(
            model_name='solarrooftop',
            name='inputFile_date',
            field=models.DateTimeField(default=datetime.datetime(2022, 8, 27, 15, 0, 13, 649193), max_length=100),
        ),
    ]
